export const Skills = [
    ...
    { id: "bfbl", klass: "warr", tag: ["skwarr", "battle", "fire", "xdmg", "fdmg"], posx: 1, level: 35, prerequisite: ["bele"], icon: "Ability_Warrior_PunishingBlow", name: "烈火剑法", description: "对指定行的第一个目标造成一次普通攻击并附加物理攻击{0.2}%的火焰伤害。当前增加{1}。\n每级学习的元素剑术可提供额外{2.2}%加成，当前提升{3.2}%。", n1: 50, n2: 7, n3: 3 },
